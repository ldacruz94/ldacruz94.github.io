    ...
    return (
      <section>
        ...
        <p className="text-lg">
          ...
          I like to read a lot of books on how to improve as a software engineer.
        </p>
        <p className="text-lg pt-5">
          I currently own over 300+ e-books (200+ on Kindle), and
          around 60 paperback books and textbooks.
        </p>
