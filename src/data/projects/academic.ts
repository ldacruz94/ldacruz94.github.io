export const academicProjects = [
	{
		...
		description: `
			Built a comprehensive hotel management application for handling reservations,
	...
	{
		title: "Most Optimized Delivery Route",
		link: "https://www.wgu.edu/",
		description: `
			Developed an optimization algorithm to solve the vehicle routing problem and find
	...
	{
		title: "Pollution Level Predictor",
		link: "https://www.wgu.edu/",
		description: `
			Created a machine learning model to predict pollution levels using Random Forest algorithm
	...
	{
		title: "Walmart Forecast Detection",
		link: "https://www.wgu.edu/",
		description: `
			Solved a demand forecasting problem for Walmart using Random Forest classification and
