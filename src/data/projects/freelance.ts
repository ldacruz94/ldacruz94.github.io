export const freelanceProjects = [
	{
		title: "Playwright Test Suite Migration",
		link: "https://www.torchlight.care/",
		description: `
			Migrated legacy Selenium-based test suites to Playwright for a startup automation client.
	...
	},
	{
		...
		link: "https://www.torchlight.care/",
		description: `
			Developed a concurrent Python tool to rapidly audit third-party government links embedded within applications.
			The tool quickly detected broken links caused by government department closures during the DOGE (Department of Government Efficiency) initiative.
	...
	},
	{
		...
		link: "#",
		description: `
			Created a robust test automation framework using Selenium with Page Object Model (POM) design pattern
			to enable consistent and maintainable test creation across two core commercial applications.
