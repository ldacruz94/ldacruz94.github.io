export const professionalProjects = [
	{
		...
		description: `
			Leading the development of an AI-powered product recommendation system designed to serve tens of thousands of field agents.
			The system leverages Retrieval-Augmented Generation (RAG) and agentic engineering patterns to deliver intelligent,
    ...
    },
    {
        ...
        `,
        technologies: ['Python', 'FastAPI', 'Docker', 'Blob Storage'],
        type: 'Professional'
    },
    {
        ...
        `,
        technologies: ['Terraform', 'CI/CD', 'Azure', 'Azure Blob Storage', 'CDN', 'Microfrontends'],
        type: 'Professional'
    },
    {
        ...
        `,
        technologies: ['Python', 'AI/ML', 'LLMs'],
        type: 'Professional'
    },
    {
    ...
    },
    {
        ...
        `,
        technologies: ['Azure Data Factory', 'ETL', 'Azure SQL'],
        type: 'Professional'
    },
    {
        ...
        `,
        technologies: ['Python', 'Databricks', 'Apache Spark', 'ETL', 'Distributed Systems'],
        type: 'Professional'
    },
    {
        ...
        `,
        technologies: ['Java', 'Spring Batch', 'Multithreading', 'SQL'],
        type: 'Professional'
    },
    {
        ...
        `,
        technologies: ['React', 'TypeScript', 'Spring Boot', 'Java', 'MySQL'],
        type: 'Professional'
    },
    {
        ...
        `,
        technologies: ['React', 'TypeScript', 'Python', 'FastAPI', 'PostgreSQL', 'DevSecOps'],
        type: 'Professional'
    }
];
